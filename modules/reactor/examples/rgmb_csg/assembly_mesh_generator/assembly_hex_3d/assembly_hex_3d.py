...
rgmb_region_17 = openmc.Material(name="rgmb_region_17")
rgmb_region_17.add_nuclide('U235', 0.03)
rgmb_region_17.add_nuclide('U238', 0.97)
rgmb_region_17.add_nuclide('O16', 2.0)
rgmb_region_17.set_density('g/cm3', 10.0)
...
openmc_mats = openmc.Materials([rgmb_region_1, rgmb_region_11, rgmb_region_12, rgmb_region_13, rgmb_region_15, rgmb_region_16, rgmb_region_17, rgmb_region_2, rgmb_region_3, rgmb_region_5, rgmb_region_6, rgmb_region_7])
openmc_mats.export_to_xml()

# Define surfaces
amg_radial_duct_0_surf_0 = openmc.Plane(d=-3.5, b=-0.866025, c=4.6544e-18, a=-0.5)
amg_radial_duct_0_surf_1 = openmc.Plane(d=-3.5, b=-0.866025, c=2.63322e-18, a=0.5)
amg_radial_duct_0_surf_2 = openmc.Plane(d=-3.5, b=-3.29651e-16, c=-7.40149e-18, a=1)
amg_radial_duct_0_surf_3 = openmc.Plane(d=-3.5, b=0.866025, c=-1.75548e-18, a=0.5)
amg_radial_duct_0_surf_4 = openmc.Plane(d=-3.5, b=0.866025, c=-3.77666e-18, a=-0.5)
amg_radial_duct_0_surf_5 = openmc.Plane(d=-3.5, b=6.59301e-16, c=0, a=-1)
amg_radial_duct_1_surf_0 = openmc.Plane(d=-3.55157, b=-0.866025, c=-5.25613e-18, a=-0.5, boundary_type='vacuum')
amg_radial_duct_1_surf_1 = openmc.Plane(d=-3.55158, b=-0.866025, c=-9.64573e-18, a=0.5, boundary_type='vacuum')
amg_radial_duct_1_surf_2 = openmc.Plane(d=-3.55157, b=-3.24864e-16, c=-7.40149e-18, a=1, boundary_type='vacuum')
amg_radial_duct_1_surf_3 = openmc.Plane(d=-3.55157, b=0.866025, c=-8.37219e-19, a=0.5, boundary_type='vacuum')
amg_radial_duct_1_surf_4 = openmc.Plane(d=-3.55157, b=0.866025, c=-5.22682e-18, a=-0.5, boundary_type='vacuum')
amg_radial_duct_1_surf_5 = openmc.Plane(d=-3.55158, b=6.49727e-16, c=0, a=-1, boundary_type='vacuum')
...
amg_duct_radial_0_axial_1 = openmc.Cell(fill=rgmb_region_17, region=(+rgmb_axial_plane_1))
amg_duct_radial_0_axial_0 = openmc.Cell(fill=rgmb_region_7, region=(-rgmb_axial_plane_1))
amg_duct_radial_0_univ = openmc.Universe(cells=[amg_duct_radial_0_axial_0, amg_duct_radial_0_axial_1])
amg_duct_cell_radial_0 = openmc.Cell(fill=amg_duct_radial_0_univ, region=(~(+amg_radial_duct_0_surf_0 & +amg_radial_duct_0_surf_1 & +amg_radial_duct_0_surf_2 & +amg_radial_duct_0_surf_3 & +amg_radial_duct_0_surf_4 & +amg_radial_duct_0_surf_5)))
amg_lattice_outer_axial_1 = openmc.Cell(fill=rgmb_region_16, region=(+rgmb_axial_plane_1))
amg_lattice_outer_axial_0 = openmc.Cell(fill=rgmb_region_6, region=(-rgmb_axial_plane_1))
amg_lattice_outer_univ = openmc.Universe(cells=[amg_lattice_outer_axial_0, amg_lattice_outer_axial_1])
pin2_cell_radial_0_axial_1 = openmc.Cell(fill=rgmb_region_13, region=(+rgmb_axial_plane_1))
pin2_cell_radial_0_axial_0 = openmc.Cell(fill=rgmb_region_3, region=(-rgmb_axial_plane_1))
pin2_univ = openmc.Universe(cells=[pin2_cell_radial_0_axial_0, pin2_cell_radial_0_axial_1])
pin1_cell_radial_2_axial_1 = openmc.Cell(fill=rgmb_region_15, region=(~(+pin1_radial_duct_1_surf_0 & +pin1_radial_duct_1_surf_1 & +pin1_radial_duct_1_surf_2 & +pin1_radial_duct_1_surf_3 & +pin1_radial_duct_1_surf_4 & +pin1_radial_duct_1_surf_5) & +rgmb_axial_plane_1))
pin1_cell_radial_2_axial_0 = openmc.Cell(fill=rgmb_region_5, region=(~(+pin1_radial_duct_1_surf_0 & +pin1_radial_duct_1_surf_1 & +pin1_radial_duct_1_surf_2 & +pin1_radial_duct_1_surf_3 & +pin1_radial_duct_1_surf_4 & +pin1_radial_duct_1_surf_5) & -rgmb_axial_plane_1))
...
pin1_cell_radial_1_axial_0 = openmc.Cell(fill=rgmb_region_2, region=((+pin1_radial_duct_1_surf_0 & +pin1_radial_duct_1_surf_1 & +pin1_radial_duct_1_surf_2 & +pin1_radial_duct_1_surf_3 & +pin1_radial_duct_1_surf_4 & +pin1_radial_duct_1_surf_5) & ~(-pin1_radial_ring_0) & -rgmb_axial_plane_1))
pin1_cell_radial_0_axial_1 = openmc.Cell(fill=rgmb_region_11, region=(-pin1_radial_ring_0 & +rgmb_axial_plane_1))
pin1_cell_radial_0_axial_0 = openmc.Cell(fill=rgmb_region_1, region=(-pin1_radial_ring_0 & -rgmb_axial_plane_1))
...
amg_lattice_unrotated.pitch = (1.42063,)
amg_lattice_unrotated.center = (0, 0)
amg_lattice_unrotated.outer = amg_lattice_outer_univ
amg_lattice_unrotated.universes = [
  [pin2_univ, pin2_univ, pin2_univ, pin2_univ, pin2_univ, pin2_univ],
  [pin1_univ]
]
...
amg_root_cell = openmc.Cell(fill=amg_univ, region=(+amg_radial_duct_1_surf_0 & +amg_radial_duct_1_surf_1 & +amg_radial_duct_1_surf_2 & +amg_radial_duct_1_surf_3 & +amg_radial_duct_1_surf_4 & +amg_radial_duct_1_surf_5 & +rgmb_axial_plane_0 & -rgmb_axial_plane_2))
