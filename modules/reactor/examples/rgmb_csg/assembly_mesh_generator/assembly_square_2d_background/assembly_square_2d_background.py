...
openmc_mats = openmc.Materials([rgmb_region_1, rgmb_region_2, rgmb_region_3, rgmb_region_5, rgmb_region_6])
...
rgmb_region_6_cell = openmc.Cell(fill=rgmb_region_6)
rgmb_region_6_univ = openmc.Universe(cells=[rgmb_region_6_cell])
amg_lattice = openmc.RectLattice()
amg_lattice.pitch = (1.25, 1.25)
amg_lattice.lower_left = (-1.25, -1.25)
amg_lattice.outer = rgmb_region_6_univ
