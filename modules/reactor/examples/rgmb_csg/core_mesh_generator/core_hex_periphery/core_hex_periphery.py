...
# Define surfaces
cmg_radial_ring = openmc.ZCylinder(r=15, y0=0, x0=0, boundary_type='vacuum')
...
pin1_cell_radial_2_axial_0 = openmc.Cell(fill=rgmb_region_5, region=(~(+pin1_radial_duct_1_surf_0 & +pin1_radial_duct_1_surf_1 & +pin1_radial_duct_1_surf_2 & +pin1_radial_duct_1_surf_3 & +pin1_radial_duct_1_surf_4 & +pin1_radial_duct_1_surf_5)))
...
amg2_lattice_unrotated.universes = [
  [pin1_univ, pin1_univ, pin3_univ, pin1_univ, pin1_univ, pin1_univ],
  [pin3_univ]
]
