...
openmc_mats = openmc.Materials([rgmb_region_1, rgmb_region_2, rgmb_region_3, rgmb_region_4, rgmb_region_5, rgmb_region_6, rgmb_region_7])
openmc_mats.export_to_xml()

# Define surfaces
amg2_radial_duct_0_expanded_surf_0 = openmc.Plane(d=1.2, b=0, c=0, a=1)
amg2_radial_duct_0_expanded_surf_1 = openmc.Plane(d=1.2, b=1, c=0, a=6.12323e-17)
amg2_radial_duct_0_expanded_surf_2 = openmc.Plane(d=1.2, b=1.22465e-16, c=0, a=-1)
amg2_radial_duct_0_expanded_surf_3 = openmc.Plane(d=1.2, b=-1, c=0, a=-1.83697e-16)
...
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_0 = openmc.Plane(d=0.38, b=0, c=0, a=1)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_1 = openmc.Plane(d=0.38, b=1, c=0, a=6.12323e-17)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_2 = openmc.Plane(d=0.38, b=1.22465e-16, c=0, a=-1)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_3 = openmc.Plane(d=0.38, b=-1, c=0, a=-1.83697e-16)
...
amg2_duct_radial_0_axial_0 = openmc.Cell(fill=rgmb_region_7)
amg2_duct_radial_0_univ = openmc.Universe(cells=[amg2_duct_radial_0_axial_0])
amg2_duct_cell_radial_0 = openmc.Cell(fill=amg2_duct_radial_0_univ, region=(~(-amg2_radial_duct_0_expanded_surf_0 & -amg2_radial_duct_0_expanded_surf_1 & -amg2_radial_duct_0_expanded_surf_2 & -amg2_radial_duct_0_expanded_surf_3)))
amg2_lattice_outer_axial_0 = openmc.Cell(fill=rgmb_region_6)
...
amg2_lattice.pitch = (1, 1)
amg2_lattice.lower_left = (-1, -1)
amg2_lattice.outer = amg2_lattice_outer_univ
amg2_lattice.universes = [
  [pin3_ducted_pin_unit_expanded_root, pin1_ducted_pin_unit_expanded_root],
  [pin1_ducted_pin_unit_expanded_root, pin3_ducted_pin_unit_expanded_root]
]
amg2_lattice_cell = openmc.Cell(fill=amg2_lattice, region=(-amg2_radial_duct_0_expanded_surf_0 & -amg2_radial_duct_0_expanded_surf_1 & -amg2_radial_duct_0_expanded_surf_2 & -amg2_radial_duct_0_expanded_surf_3))
amg2_univ = openmc.Universe(cells=[amg2_lattice_cell, amg2_duct_cell_radial_0])
