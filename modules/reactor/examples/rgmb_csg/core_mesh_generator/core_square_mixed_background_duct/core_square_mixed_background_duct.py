...
# Define surfaces
amg2_radial_duct_0_surf_0 = openmc.Plane(d=-1.2, b=-1, c=-2.46716e-18, a=-9.25186e-17)
amg2_radial_duct_0_surf_1 = openmc.Plane(d=-1.2, b=-1.85037e-16, c=0, a=1)
amg2_radial_duct_0_surf_2 = openmc.Plane(d=-1.2, b=1, c=0, a=1.85037e-16)
amg2_radial_duct_0_surf_3 = openmc.Plane(d=-1.2, b=2.77556e-16, c=-2.46716e-18, a=-1)
cmg_radial_ring = openmc.ZCylinder(r=5.68252, y0=0, x0=0, boundary_type='vacuum')
pin1_radial_duct_1_surf_0 = openmc.Plane(d=-0.38, b=-1, c=6.16791e-19, a=-7.3041e-17)
pin1_radial_duct_1_surf_1 = openmc.Plane(d=-0.38, b=-1.46082e-16, c=0, a=1)
pin1_radial_duct_1_surf_2 = openmc.Plane(d=-0.38, b=1, c=0, a=1.46082e-16)
pin1_radial_duct_1_surf_3 = openmc.Plane(d=-0.38, b=2.19123e-16, c=6.16791e-19, a=-1)
...
amg2_duct_cell_radial_0 = openmc.Cell(fill=amg2_duct_radial_0_univ, region=(~(+amg2_radial_duct_0_surf_0 & +amg2_radial_duct_0_surf_1 & +amg2_radial_duct_0_surf_2 & +amg2_radial_duct_0_surf_3)))
...
amg2_lattice_cell = openmc.Cell(fill=amg2_lattice, region=(+amg2_radial_duct_0_surf_0 & +amg2_radial_duct_0_surf_1 & +amg2_radial_duct_0_surf_2 & +amg2_radial_duct_0_surf_3))
