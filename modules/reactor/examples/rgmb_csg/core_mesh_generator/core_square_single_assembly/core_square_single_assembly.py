...
openmc_mats = openmc.Materials([rgmb_region_1, rgmb_region_2, rgmb_region_5])
openmc_mats.export_to_xml()

# Define surfaces
cmg_radial_boundary = openmc.ZCylinder(r=2.00907, y0=0, x0=0, boundary_type='vacuum')
...
cmg_lattice.pitch = (1.42063, 1.42063)
cmg_lattice.lower_left = (-1.42063, -1.42063)
cmg_lattice.outer = empty_univ
cmg_lattice.universes = [
  [pin2_ducted_pin_unit_expanded_root, pin1_ducted_pin_unit_expanded_root],
