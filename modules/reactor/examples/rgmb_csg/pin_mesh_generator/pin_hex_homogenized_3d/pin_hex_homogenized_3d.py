...
pin1_cell_radial_0_axial_0 = openmc.Cell(fill=rgmb_region_1)
pin1_univ = openmc.Universe(cells=[pin1_cell_radial_0_axial_0])
pin1_root_cell = openmc.Cell(fill=pin1_univ, region=(+pin1_radial_duct_0_surf_0 & +pin1_radial_duct_0_surf_1 & +pin1_radial_duct_0_surf_2 & +pin1_radial_duct_0_surf_3 & +pin1_radial_duct_0_surf_4 & +pin1_radial_duct_0_surf_5 & +rgmb_axial_plane_0 & -rgmb_axial_plane_1))
