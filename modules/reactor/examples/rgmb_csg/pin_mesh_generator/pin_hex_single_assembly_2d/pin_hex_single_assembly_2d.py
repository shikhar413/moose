...
# Define surfaces
pin1_ducted_pin_unit_pin_unit_radial_ring_0 = openmc.ZCylinder(r=2, y0=0, x0=0)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_0 = openmc.Plane(d=3, b=0, c=0, a=1)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_1 = openmc.Plane(d=3, b=0.866025, c=0, a=0.5)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_2 = openmc.Plane(d=3, b=0.866025, c=0, a=-0.5)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_3 = openmc.Plane(d=3, b=1.22465e-16, c=0, a=-1)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_4 = openmc.Plane(d=3, b=-0.866025, c=0, a=-0.5)
pin1_ducted_pin_unit_radial_duct_0_expanded_surf_5 = openmc.Plane(d=3, b=-0.866025, c=0, a=0.5)
pin1_radial_boundary_expanded_surf_0 = openmc.Plane(d=3.55158, b=0, c=0, a=1, boundary_type='vacuum')
pin1_radial_boundary_expanded_surf_1 = openmc.Plane(d=3.55158, b=0.866025, c=0, a=0.5, boundary_type='vacuum')
pin1_radial_boundary_expanded_surf_2 = openmc.Plane(d=3.55158, b=0.866025, c=0, a=-0.5, boundary_type='vacuum')
pin1_radial_boundary_expanded_surf_3 = openmc.Plane(d=3.55158, b=1.22465e-16, c=0, a=-1, boundary_type='vacuum')
pin1_radial_boundary_expanded_surf_4 = openmc.Plane(d=3.55158, b=-0.866025, c=0, a=-0.5, boundary_type='vacuum')
pin1_radial_boundary_expanded_surf_5 = openmc.Plane(d=3.55158, b=-0.866025, c=0, a=0.5, boundary_type='vacuum')
...
pin1_root_cell = openmc.Cell(fill=pin1_ducted_pin_unit_expanded_root, region=(-pin1_radial_boundary_expanded_surf_0 & -pin1_radial_boundary_expanded_surf_1 & -pin1_radial_boundary_expanded_surf_2 & -pin1_radial_boundary_expanded_surf_3 & -pin1_radial_boundary_expanded_surf_4 & -pin1_radial_boundary_expanded_surf_5))
