...
pin1_cell_radial_3_axial_1 = openmc.Cell(fill=rgmb_region_8, region=(~(-pin1_radial_ring_2) & +rgmb_axial_plane_1))
pin1_cell_radial_3_axial_0 = openmc.Cell(fill=rgmb_region_4, region=(~(-pin1_radial_ring_2) & -rgmb_axial_plane_1))
pin1_cell_radial_2_axial_1 = openmc.Cell(fill=rgmb_region_7, region=(-pin1_radial_ring_2 & ~(-pin1_radial_ring_1) & +rgmb_axial_plane_1))
pin1_cell_radial_2_axial_0 = openmc.Cell(fill=rgmb_region_3, region=(-pin1_radial_ring_2 & ~(-pin1_radial_ring_1) & -rgmb_axial_plane_1))
pin1_cell_radial_1_axial_1 = openmc.Cell(fill=rgmb_region_6, region=(-pin1_radial_ring_1 & ~(-pin1_radial_ring_0) & +rgmb_axial_plane_1))
pin1_cell_radial_1_axial_0 = openmc.Cell(fill=rgmb_region_2, region=(-pin1_radial_ring_1 & ~(-pin1_radial_ring_0) & -rgmb_axial_plane_1))
pin1_cell_radial_0_axial_1 = openmc.Cell(fill=rgmb_region_5, region=(-pin1_radial_ring_0 & +rgmb_axial_plane_1))
pin1_cell_radial_0_axial_0 = openmc.Cell(fill=rgmb_region_1, region=(-pin1_radial_ring_0 & -rgmb_axial_plane_1))
pin1_univ = openmc.Universe(cells=[pin1_cell_radial_0_axial_0, pin1_cell_radial_0_axial_1, pin1_cell_radial_1_axial_0, pin1_cell_radial_1_axial_1, pin1_cell_radial_2_axial_0, pin1_cell_radial_2_axial_1, pin1_cell_radial_3_axial_0, pin1_cell_radial_3_axial_1])
pin1_root_cell = openmc.Cell(fill=pin1_univ, region=(+pin1_radial_duct_3_surf_0 & +pin1_radial_duct_3_surf_1 & +pin1_radial_duct_3_surf_2 & +pin1_radial_duct_3_surf_3 & +rgmb_axial_plane_0 & -rgmb_axial_plane_2))
