...
# Define surfaces
pin1_radial_duct_1_surf_0 = openmc.Plane(d=-3, b=-1, c=4.93432e-18, a=-7.40149e-17)
pin1_radial_duct_1_surf_1 = openmc.Plane(d=-3, b=-1.4803e-16, c=0, a=1)
pin1_radial_duct_1_surf_2 = openmc.Plane(d=-3, b=1, c=0, a=1.4803e-16)
pin1_radial_duct_1_surf_3 = openmc.Plane(d=-3, b=2.22045e-16, c=4.93432e-18, a=-1)
pin1_radial_duct_2_surf_0 = openmc.Plane(d=-3.55157, b=-1, c=-4.93432e-18, a=-6.252e-17, boundary_type='vacuum')
pin1_radial_duct_2_surf_1 = openmc.Plane(d=-3.55158, b=-1.2504e-16, c=0, a=1, boundary_type='vacuum')
pin1_radial_duct_2_surf_2 = openmc.Plane(d=-3.55158, b=1, c=0, a=1.2504e-16, boundary_type='vacuum')
pin1_radial_duct_2_surf_3 = openmc.Plane(d=-3.55157, b=2.5008e-16, c=0, a=-1, boundary_type='vacuum')
pin1_radial_ring_0 = openmc.ZCylinder(r=2, y0=0, x0=0)

# Define cells, universes, and lattices
pin1_cell_radial_2 = openmc.Cell(fill=rgmb_region_3, region=(~(+pin1_radial_duct_1_surf_0 & +pin1_radial_duct_1_surf_1 & +pin1_radial_duct_1_surf_2 & +pin1_radial_duct_1_surf_3)))
...
pin1_root_cell = openmc.Cell(fill=pin1_univ, region=(+pin1_radial_duct_2_surf_0 & +pin1_radial_duct_2_surf_1 & +pin1_radial_duct_2_surf_2 & +pin1_radial_duct_2_surf_3))
